class SyseEngine {
    ...
    sysReadyFn() {
        ...
        this.showTime();
        this.eventAdd(this.oFullScreen, "click", () => {
        ...
        this.eventAdd(this.oBaymax, "click", () => {
            this.handleFocusInput();
        }, true);
        this.eventAdd(this.oBg, "click", () => {
            this.clearInput();
        }, true);
    };
    // 绑定事件
    ...
    showDate() {
        ...
        const gDay1 = oDate.getDay() + 1;
        const gHour = oDate.getHours();
        const gMinute = oDate.getMinutes();
        const gSeconds = oDate.getSeconds();
        const t1 = this.transForm(gYear) + '年' + this.transForm(gMonth) + '月' + this.transForm(gDay) + '日' + "  " + "星期" + this.transformC(gDay1);
        const t2 = this.transForm(gHour) + ':' + this.transForm(gMinute) + ':' + this.transForm(gSeconds);
